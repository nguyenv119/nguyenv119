...
In this new arena, I observed the stark duality of CS. A select few, brilliant minds, raced ahead effortlessly, while the vast majority grappled with the demands — and they grappled hard. Some lost their spirit, their will to keep trying. Either they physically quit by dropping out, or emotionally quit by merely going through the motions in class, their vacant eyes staring into the projector but not taking any information, tears streaming down their faces after exams. All under the crushing weight of a single question, "what's the point?"
